...
class SubjectInfo(BaseModel):
    """Information about a single subject - compatible with NiftiDataLoaderPiece output"""
    subject_id: str
    image_path: str
...
class InputModel(BaseModel):
    ...
    subjects: Optional[List[SubjectInfo]] = Field(
        description="List of subjects from upstream piece (e.g., NiftiDataLoaderPiece). If provided, dataset_config_path is ignored.",
        default=None
    )
