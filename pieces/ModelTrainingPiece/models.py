...
class InputModel(BaseModel):
    ...
    dataset_config_path: str = Field(
        description="Path to dataset_config.json generated by PituitaryDatasetPiece",
        default="/home/shared_storage/dataset_config.json"
    )
    data_root: str = Field(
        description="Root directory containing images and masks subdirectories",
